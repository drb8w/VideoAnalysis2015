...
std::vector<cv::Mat *> *GetSpatialTemporalFramePtrsXt(std::vector<cv::Mat *> &frames, std::vector<cv::Mat *> *framesXt);

std::vector<cv::Mat> *GetSpatialTemporalFramesXt(std::vector<cv::Mat> *frames);
std::vector<cv::Mat *> *GetSpatialTemporalFramePtrsXt(std::vector<cv::Mat *> &frames);
...
std::vector<cv::Mat *> *GetSpatialTemporalFramePtrs(std::vector<cv::Mat *> &videoFrames, std::vector<cv::Mat *> *trainingFrames, bool useFramesXY = true, bool useFramesXt = true, bool useFramesYt = true);
...
std::vector<cv::Mat *> *GetSpatialTemporalFramePtrs(std::vector<cv::Mat *> &videoFrames, bool useFramesXY = true, bool useFramesXt = true, bool useFramesYt = true);
